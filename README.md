...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/opal-opa/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-opal-opa.git
cd tp-opal-opa
```
...
```bash
kubectl port-forward deployment/tp-opal-opa 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── policy.rego     # Main configuration file
```
...
---
*Generated by [OPAL & OPA Policy Controller Studio](https://pradeeptalari14.github.io/portfolio/tools/opal-opa/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
